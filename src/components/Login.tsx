...
export default function Login(): JSX.Element {
  ...
  const signUpWithGoogle = async () => {
    try {
      ...
      //   response = await axios.post("http://localhost:3001/api/v1/userdata", { name: responseGoogle.user.displayName, email: responseGoogle.user.email, photo: responseGoogle.user.photoURL }, {
      ...
      // }
      // else {
      //   response = await axios.get("http://localhost:3001/api/v1/getuserdata", {
      //     withCredentials: true,
      //     headers: {
      //       "Content-Type": "application/json"
      //     }
