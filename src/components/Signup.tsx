...
export default function SignUp(): JSX.Element {
  ...
  const signUpWithGoogle = async () => {
    try {
      ...
      if (additionalUserInfo?.isNewUser) {
        response = await axios.post("http://localhost:3000/api/v1/userdata", { name: responseGoogle.user.displayName, email: responseGoogle.user.email, photo: responseGoogle.user.photoURL }, {
        ...
        response = await axios.get("http://localhost:3000/api/v1/getuserdata", {
          withCredentials: true,
          headers: {
            "Content-Type": "application/json"
          }
  ...
  const signUp = async (data: any) => {
    ...
    try {
      ...
      // const adduser = await axios.post("http://localhost:3000/api/v1/adduser", data, {
      //   withCredentials: true,
      //   headers: {
      //     "Content-Type": "application/json"
      //   }
      // })
      // console.log(adduser);
      // dispatch(authLogin(adduser.data))
      navigate("/dashboard")
          ...
          <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
            ...
            <form onSubmit={formMethods.handleSubmit(signUp)}>
              ...
              <TEInput
                ...
                label="Email address"
                size="lg"
                className="mb-6 bg-neutral-400 border-black"
              ></TEInput>
